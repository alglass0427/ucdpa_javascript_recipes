 ...
 *
 * The @param describe the parameters of the function. There are three parts of it. 
 * First is within {}. It suggests the type of the param. Second is name of the param. 
 * Third is after they hyphen(-) sign. It describes the parameter.
 * 
 * 
 * @constructor
...
const JSCarousel = ({
    ...
    //---HANDLE ERROR IF PASSES IN VALUES ARE NOT AS EXPECTED///////
    //***********************************************************
